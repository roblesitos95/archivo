...
if (isset($_SESSION['sesion'])) {
    ...
    <?php $id = $_GET["editar"];
    $id = base64_decode($id);
    $import = impotacionesclass::buscarForId($id);

    if (count($import) > 0) {

        foreach ($import as $valor) {
            $id = $valor->getIdcarpeta();
            $nombre = $valor->getnombre();
            $producto = $valor->getProductos();
            $fecha = $valor->getFechaDocumento();
            $liquidacion = $valor->getLiquidacion();
            $pedido = $valor->getPedido();
            $ubicacion = $valor->getUbicacion();
            $area = $valor->getArea();
            list($sala, $fila, $cara, $estante, $balda, $am) = preg_split('[-]', $ubicacion);
            list($numer1, $cdl) = preg_split('[ - ]', $liquidacion);
            list($numer2, $cdp) = preg_split('[ - ]', $pedido);
        }
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form id="TypeValidation" class="form-horizontal"
                              action="../../Controlador/imporacioncontroller.php?action=editar" method="post">
                            ...
                            <div class="card-content">
                                <div class="row">
                                    ...
                                    <label class="col-sm-2 label-on-left">Nombre Carpeta</label>
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating">
                                            <input name="Nombre" id="Nombre" type="text" class="form-control datepicker"
                                ...
                                <div class="row">
                                    ...
                                    <label class="col-sm-2 label-on-left">Productos</label>
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating">
                                            <label class="control-label"></label>
                                            <textarea class="form-control" name="Productos" required="true"
                                                      id="Productos"><?php echo $producto; ?></textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <label class="col-sm-2 label-on-left">Consecutivo de Liquidacion</label>
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input value="<?php echo $cdl; ?>" type="text" class="form-control "
                                                   required="true" name="liquidacion" id="liquidacion"/>
                                            <span class="help-block">Por favor solo digite el numero de consecutivo</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <label class="col-sm-2 label-on-left">Consecutivo de Pedido</label>
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="text" class="form-control" value="<?php echo $cdp; ?>"
