                        ...
                        <div class="card-content">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group label-floating">
                                        ...
                                        <select class="form-control" name="Area" id="Area" required  >
                                            ...
                                            <option value="GESTION_DOCUMENTAL_ARCHIVISTICA"> Gestion Documental Archivistica</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group label-floating">
                                        <label class="control-label"></label>
                                              <select  class="js-example-basic-multiple yrselectdesc form-control" name="anho[]" multiple="multiple" id="Anho" required="Area" ></select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group label-floating">
                                        <input type="text" class="form-control " required="true" name="Asunto" id="Asunto" />
                                    </div>
                                </div>
                            </div>
