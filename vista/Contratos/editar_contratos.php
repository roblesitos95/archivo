                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form id="TypeValidation" class="form-horizontal" action="../../Controlador/Contratoscontroller.php?action=editar" method="post">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <label class="control-label"></label>
                                                <input type="text" name="Contratista" id="Contratista" class="form-control" required="true" value="<?php echo $Contratista?>" />
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="ver_contratos.php"> <button class="btn btn-danger hvr-float "  type="button"  >
