                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form id="TypeValidation" class="form-horizontal"
                              action="../../Controlador/prestamoscontroller.php?action=crear" method="post">
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating">
                                            <label class="control-label"></label>
                                            <input type="text" name="Fechaenvio" id="Fechaenvio" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating">
                                            <label class="control-label"></label>
                                            <input type="text" class="form-control" required name="Destinatario"
                                                   id="Destinatario">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating">
                                            <label class="control-label"></label>
                                            <textarea class="form-control" required="true" name="Observaciones"
