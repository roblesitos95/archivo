                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form id="TypeValidation" class="form-horizontal" action="../../Controlador/facturacontroller.php?action=editar" method="post">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <label class="control-label"></label>
                                                <input class="form-control" type="text" name="Titular" id="Titular" required="true" value="<?php echo $Titular?>" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <label class="control-label"></label>
                                                <input type="text" class="form-control" required="true" id="NIT" name="NIT"  value="<?php echo $NIT?>"  />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <input type="text" class="form-control "  value="<?php echo $Contable?>" required="true" name="Contable" id="Contable" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="ver_factura.php"> <button class="btn btn-danger"  type="button"  >
