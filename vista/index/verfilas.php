                        ...
                        <div class="col-md-4 animated bounceIn" >
                            <li class="fil">
                                ...
                                <footer class="cd-pricing-footer">
                                    <a onclick="showini(<?php echo $row['idFilas']; ?>,<?php echo  $row['idsala_fila']; ?>)" class="hvr-curl-bottom-right" href="#0">Contenido</a>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-10">
                                                        <div class="form-group label-floating">
                                                            <select class="form-control" name="tipodoc" id="tipodoc" required onchange="form4()" >
