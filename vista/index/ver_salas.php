                        ...
                        <div class="card card-product">
                            ...
                            <div class="card-content">
                                <div class="card-actions">
                                    ...
                                    <button type="button"
                                            class="btn btn-primary btn-simple btn-xs hvr-bounce-in hvr-radial-out fix-broken-card">
                                        <i class="ion-refresh"></i>
                                    </button>

                                    <button type="button" class="btn btn-default btn-simple" rel="tooltip"
                                            data-placement="bottom" title="Ver mas">
                                        <a href="Filas_<?php echo $id; ?>"><i class="icon-list-alt"></i></a>
                                    </button>

                                    <button type="button" class="btn btn-success btn-simple" rel="tooltip"
                                            data-placement="bottom" id="myBtn" title="Editar"
                                            onclick="descirp(<?php echo $id; ?>)">
