                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form id="TypeValidation" class="form-horizontal" action="../../Controlador/Escrituracontroller.php?action=editar" method="post">
                                ...
                                <div class="card-content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control" type="text" name="Numero" id="Numero" value="<?php echo $Numero ?>"vrequired="true" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <label class="control-label"></label>
                                                <input class="form-control" type="text" name="Notaria" id="Notaria" required="true" value="<?php echo $Notaria ?>" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <label class="control-label"></label>
                                                <input type="text" class="form-control" required="true" id="De" name="De" value="<?php echo $De ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <input type="text" class="form-control " required="A" name="A" id="A" value="<?php echo $A ?>" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="ver_escrituras.php "> <button class="btn btn-danger hvr-float "  type="button"  >
