                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form id="TypeValidation" class="form-horizontal"
                              action="../../Controlador/Contablecontroller.php?action=editar" method="post">
                            ...
                            <div class="card-content">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" type="text" name="Documento" id="Documento"
                                                   required="true" value="<?php echo $Documento ?>"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating">
                                            <label class="control-label"></label>
                                            <input type="text" class="form-control" required="true" id="Proveedor"
                                                   name="Proveedor" value="<?php echo $Proveedor ?>"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating">
                                            <input type="text" class="form-control " required="true" name="Factura"
                                                   id="Factura" value="<?php echo $Factura ?>"/>
                                        </div>
                                    </div>
                                </div>
