        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form id="TypeValidation" class="form-horizontal" action="../../Controlador/seguridadcontroller.php?action=editar" method="post">
                        ...
                        <div class="card-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" name="documento" id="documento" class="form-control " value="<?php echo $Documento?>" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group label-floating">
                                        <label class="control-label"></label>
                                        <input type="text" name="empresadeservicio" id="empresadeservicio" class="form-control " value="<?php echo $getEmpresadeservicio?>" required="true" />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group label-floating">
                                        <label class="control-label"></label>
                                        <input type="text" name="empresalaboral" id="empresalaboral" class="form-control " value="<?php echo $getEmpresalaboral?>" required="true" />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" name="Ciudad" id="Ciudad" class="form-control " value="<?php echo $getCiudad?>"  required="true"/>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control " required="true" id="Descripcion" name="Descripcion" value="<?php echo $descripcion?>"  />
                                    ...
                                    <div class="row">
                                        <div class="col-md-3    ">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input type="text" class="form-control" placeholder="Sala" name="Sala" id="Sala" value="<?php echo $sala?>" >
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group label-floating is-empty">
