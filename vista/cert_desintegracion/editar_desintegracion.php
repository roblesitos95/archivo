                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form id="TypeValidation" class="form-horizontal" action="../../Controlador/desintegracioncontroller.php?action=editar" method="post">
                                ...
                                <div class="card-content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control" type="text" value="<?php echo $Documento?>" name="Documento" id="Documento" required="true" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <label class="control-label"></label>
                                                <input class="form-control" type="text" value="<?php echo $Numero?>" name="Numero" id="Numero" required="true" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <label class="control-label"></label>
                                                <input type="text" class="form-control " required="true" id="Placa" value="<?php echo $placa?>" name="Placa"  />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group label-floating">
                                                <input type="text" class="form-control " required="true" name="Clase" id="Clase" value="<?php echo $clase?>" />
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group label-floating is-empty">
                                                        <label class="control-label"></label>
                                                        <input type="text" class="form-control" value="<?php echo $sala?>" placeholder="Sala" name="Sala" id="Sala" >
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group label-floating is-empty">
                                                        <label class="control-label"></label>
                                                        <input type="text" class="form-control" placeholder="Estante" name="Estante" value="<?php echo $estante?>" id="Estante">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group label-floating is-empty">
                                                        <label class="control-label"></label>
                                                        <input type="text" class="form-control" placeholder="Archivo modular" name="Arcivo_Modular" value="<?php echo $am?>" id="Arcivo_Modular">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="ver_desintegracion.php"> <button class="btn btn-danger hvr-float "  type="button"  >
